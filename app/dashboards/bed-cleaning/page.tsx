              ...
              <div style={{ flex: 1, minHeight: 0 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={ESPERA_H} margin={{ top: 22, right: 16, bottom: 0, left: 4 }}>
                    ...
                    <YAxis hide width={0} />
                    <Tooltip contentStyle={TS} cursor={false} labelStyle={{ color: "#f7f7f7" }} itemStyle={{ color: "#f7f7f7" }} formatter={(v)=>[`${v}`,"Leitos em espera"]} />
              ...
              <div style={{ flex: 1, minHeight: 0 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={ACEITE_H} margin={{ top: 22, right: 16, bottom: 0, left: 4 }}>
                    <XAxis dataKey="h" tick={{ fill:"#f7f7f7", fontSize:9 }} />
                    <YAxis hide width={0} />
                    <Tooltip contentStyle={TS} cursor={false} labelStyle={{ color: "#f7f7f7" }} itemStyle={{ color: "#f7f7f7" }} formatter={(v)=>[`${v}`,"Aceites"]} />
              ...
              <div style={{ flex: 1, minHeight: 0 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={ETAPAS} layout="vertical" margin={{ top: 4, right: 44, bottom: 4, left: 8 }}>
                    ...
                    <Tooltip contentStyle={TS} cursor={false} labelStyle={{ color: "#f7f7f7" }} itemStyle={{ color: "#f7f7f7" }} formatter={(v)=>[`${v} min`,"Tempo"]} />
              ...
              <div style={{ flex: 1, minHeight: 0 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={STATUS_HIGIENE} margin={{ top: 22, right: 12, bottom: 0, left: 12 }}>
                    ...
                    <YAxis hide width={0} />
                    <Tooltip contentStyle={TS} cursor={false} labelStyle={{ color: "#f7f7f7" }} itemStyle={{ color: "#f7f7f7" }} formatter={(v)=>[`${v}`,"Leitos"]} />
              ...
              <div style={{ flex: 1, minHeight: 0 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={STAFF} margin={{ top: 22, right: 12, bottom: 0, left: 12 }}>
                    ...
                    <YAxis hide width={0} />
                    <Tooltip contentStyle={TS} cursor={false} labelStyle={{ color: "#f7f7f7" }} itemStyle={{ color: "#f7f7f7" }} formatter={(v, name) => [`${v}`, name]} />
