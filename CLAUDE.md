...
**`EWSCalculator`** — função pura. Recebe 5 sinais vitais (FR, SpO₂, PAS, FC, TEMP) e retorna pontuação individual + total + Status Clínico. Tabelas NEWS2 adaptadas, escala 0–14. Regra de exceção: qualquer sinal com pontuação individual 3 eleva o status mínimo para Atenção. Limiares: 0–2=Estável, 3–4=Atenção, 5–6=Risco Elevado, ≥7=Crítico.
...
- **~5 min**: Paciente UTI deteriora (SpO₂ cai, FC sobe, EWS 3→7, alerta de Sinal Vital)
