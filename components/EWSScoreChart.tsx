    ...
    >
      ...
      <ResponsiveContainer width="100%" height={chartHeight}>
        <ComposedChart data={chartData} syncId={syncId} margin={{ top: 18, right: 20, left: 0, bottom: 0 }}>
          ...
          {/* Divisor "agora" — este é o mesmo gráfico usado na página de Predição EWS
              (EWSTab reaproveita este componente). Eixo X aqui é categórico (valores de
              `t`), então o x precisa ser exatamente o valor do ponto-ponte (último
              histórico == início da predição), não Date.now(). */}
          {hasForecast && (
            <ReferenceLine
              x={lastHist.t}
